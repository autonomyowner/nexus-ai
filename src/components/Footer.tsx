        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-5">
              <span className="font-bold text-xl text-white" style={{ fontFamily: "'Libre Baskerville', Georgia, serif" }}>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-9 h-9 bg-white/10 flex items-center justify-center text-white/70"
                >
          ...
          {/* Talent Links */}
          <div>
            <h5 className="font-semibold text-white mb-5">Talent</h5>
            <div className="flex flex-col gap-3">
              {[
          ...
          {/* Contact CTA */}
          <div>
            <h5 className="font-semibold text-white mb-5">Get Started</h5>
